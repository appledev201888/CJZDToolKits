...
Pod::Spec.new do |s|
  ...
  s.name         = "CJZDToolKits"
  s.version      = "0.0.5"
  s.summary      = "A short description of CJZDToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CJZDToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CJZDToolKits.git", :tag => "#{s.version}" }
